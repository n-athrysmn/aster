...
export const students = (req, res) => {
  const q = "SELECT studentId, studentName, studentEmail, studentNumber FROM students"
...
export const parents = (req, res) => {
  const q = "SELECT parentId, parentName, parentEmail, parentNumber FROM parents"
...
export const teachers = (req, res) => {
  const q = "SELECT teacherId, teacherName, teacherEmail, teacherNumber FROM teachers"
