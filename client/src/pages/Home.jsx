...
import { FaBook, FaBullhorn, FaChalkboardTeacher } from 'react-icons/fa'
...
const Home = () => {
    ...
    const tabs = [
      ...
      },
      {
        ...
        title: 
        <div className="tab-title">
          <div className="tab-icon"><FaChalkboardTeacher/></div>Knowledge Library
        </div>,
        content: 
        <div className="posts">
            {videos.map(video=>(
  ...
  return (
    <div className='home'>
      <div className="announce mb20">
        ...
        <div className="ann-text"> Hello everyone, welcome to Aster's dashboard. We will be updating lives and quizzes, look forward to it!</div>
